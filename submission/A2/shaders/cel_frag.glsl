...
void main() {
  ...
  // copy from our phong shader, but modifying the lambertian value as to only allow a small
  // number of shades to be present in our model.
  ...
  // everything else is same as phong
